...
def train_action_net():
    ...
    trainer.trainModel(num_objects=16, num_experiments=60, batch_size=32, save_full_model=True, enhance_data=True)
...
def run_predict():
    ...
    predictions, probabilities = predictor.predictImage(image_input="assets/5.jpg", result_count=4)
